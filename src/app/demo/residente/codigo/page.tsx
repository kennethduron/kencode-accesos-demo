      ...
      <div className="grid gap-6 lg:grid-cols-[0.82fr_1.18fr] lg:items-start">
        ...
        <section className="surface-card overflow-hidden" aria-labelledby="visit-info-title">
          ...
          <div className="grid items-start gap-3 border-t border-slate-200 bg-slate-50 p-5 sm:grid-cols-2 sm:p-6">
            ...
            <button ref={cancelButtonRef} type="button" disabled={!online || !canCancel} onClick={() => setDialogOpen(true)} className="inline-flex min-h-11 self-start items-center justify-center gap-2 rounded-xl border border-red-200 bg-white px-4 text-sm font-bold text-red-600 transition hover:bg-red-50 disabled:cursor-not-allowed disabled:border-slate-200 disabled:text-slate-400">
